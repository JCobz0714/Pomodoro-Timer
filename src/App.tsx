...
function App() {
  ...
  useEffect(() => {
      ...
      if(mode === "work"){
        ...
        if(isRunning && timer > 0){
          ...
          //Showing an alert to the user stating that the time for the break is over
          alert("Break time is up! Now It's time to start working again");
        }
      }
  ...
  }, [isRunning, timer, mode, pomodoros, minutesBreak, minutes]);
